...
import presentacion.añadir.UIAñadirCita;
...
public class PanelCitas extends javax.swing.JPanel {
    ...
    public PanelCitas() {
        ...
        String columnas[] = {"Id", "Mascota", "Fecha", "Temp.", "Peso", "Talla", "Tipo"};
    ...
    private void llenarTabla() { // este codigo es un asco pero es solo para saber como llenar el resto y como fucionan las tablas, sha bro ;v
        List<Cita> citas = CitasControlador.getCitas();
        for (Cita c : citas) {
            tm.addRow(new Object[]{c.getId(), c.getMascota().getNombre(), c.getFecha(), c.getTemperatura(), c.getPeso(), c.getTalla(), (c instanceof Quirurgica) ? "Quirurjica" : (c instanceof Emergencia) ? "Emergencia" : "Regular"});
        }
    }
    ...
    private void btnAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAñadirActionPerformed
        UIAñadirCita añadirCita = new UIAñadirCita();
        añadirCita.setSize(1003, 720);
        añadirCita.setVisible(true);
